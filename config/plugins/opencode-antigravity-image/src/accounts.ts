...
export async function updateAccountQuota(
  ...
  // Also save under cachedQuota for compatibility with quota display tools
  if (!targetAccount.cachedQuota) {
    targetAccount.cachedQuota = {};
  }
  targetAccount.cachedQuota["gemini-image"] = {
    remainingFraction,
